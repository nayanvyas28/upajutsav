...
import 'schema/crop_details_record.dart';
...
export 'schema/crop_details_record.dart';
...
/// Functions to query CropDetailsRecords (as a Stream and as a Future).
Future<int> queryCropDetailsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CropDetailsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CropDetailsRecord>> queryCropDetailsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CropDetailsRecord.collection,
      CropDetailsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CropDetailsRecord>> queryCropDetailsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>

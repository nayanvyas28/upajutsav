        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'MealDetails',
              path: 'meal',
              builder: (context, params) => const MealDetailsWidget(),
            ),
            FFRoute(
              name: 'EditProfile',
              path: 'edit-profile',
            ...
            FFRoute(
              name: 'sell_pic',
              path: 'sellPic',
              builder: (context, params) => const SellPicWidget(),
            ),
            FFRoute(
              name: 'sell_done',
              path: 'sellDone',
              builder: (context, params) => const SellDoneWidget(),
            ),
            FFRoute(
              name: 'MyOrder',
              path: 'myOrder',
            ...
            FFRoute(
              ...
              builder: (context, params) =>
                  params.isEmpty ? const NavBarPage(initialPage: 'bid') : const BidWidget(),
            ),
            FFRoute(
              name: 'create_bid',
              path: 'createBid',
              builder: (context, params) => const CreateBidWidget(),
            ),
            FFRoute(
              name: 'sell_doneCopy',
              path: 'sellDoneCopy',
              builder: (context, params) => const SellDoneCopyWidget(),
            ),
            FFRoute(
              name: 'ProfileCopy',
              path: 'profileCopy',
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'ProfileCopy')
                  : const ProfileCopyWidget(),
            ),
            FFRoute(
              name: 'MealDetailsCopy',
              path: 'MealDetailsCopy',
              asyncParams: {
                'mealRef': getDoc(['meals'], MealsRecord.fromSnapshot),
              },
              builder: (context, params) => MealDetailsCopyWidget(
